...
export const pathDescriptions = {
  ...
  fullstack: {
    ...
    strengthsNeeded: ['다방면의 기술적 이해력', '적응력', '효율적인 문제 해결', '통합적 사고'],
    challengesExpected: ['넓은 기술 스택 유지', '깊이와 넓이 사이의 균형', '다양한 기술의 빠른 변화 대응']
  },
  data: {
    title: '데이터 과학자/엔지니어',
    ...
    strengthsNeeded: ['분석적 사고', '패턴 인식 능력', '통계적 직관', '문제 정의 능력'],
    challengesExpected: ['대용량 데이터 처리', '분석 결과의 명확한 커뮤니케이션', '도메인 지식과 기술의 균형']
  },
  devops: {
    title: 'DevOps 엔지니어',
    ...
    strengthsNeeded: ['자동화에 대한 열정', '시스템 운영 이해', '문제 해결 능력', '지속적 개선 마인드'],
    challengesExpected: ['복잡한 인프라 관리', '보안과 효율성 균형', '빠른 기술 변화에 대응']
  },
  mobile: {
    title: '모바일 앱 개발자',
    ...
    strengthsNeeded: ['모바일 사용자 경험 이해', '효율적인 UI 설계', '제한된 리소스 관리 능력', '터치 인터페이스 최적화'],
    challengesExpected: ['다양한 화면 크기와 기기 호환성', '앱 스토어 정책 이해', '네트워크 환경 변화 대응']
  },
  security: {
    title: '보안 엔지니어',
    ...
    strengthsNeeded: ['방어적 사고방식', '체계적인 취약점 분석 능력', '지속적인 학습 태도', '보안 위협 예측 능력'],
    challengesExpected: ['계속 진화하는 공격 방식', '보안과 사용성 균형', '보안 이슈 커뮤니케이션']
  },
  gamedev: {
    title: '게임 개발자',
    ...
    strengthsNeeded: ['창의적 문제 해결', '게임 메카닉 이해', '사용자 경험과 재미 디자인', '최적화 능력'],
    challengesExpected: ['성능과 그래픽 품질 균형', '다양한 플랫폼 대응', '복잡한 상호작용 구현']
  },
  embedded: {
    title: '임베디드 시스템 개발자',
    ...
    strengthsNeeded: ['저수준 최적화 능력', '하드웨어-소프트웨어 통합 이해', '자원 제약 환경 설계', '디버깅 기술'],
    challengesExpected: ['제한된 자원 관리', '실시간 처리 요구사항', '하드웨어 종속성 처리']
  },
  ai: {
    title: 'AI/ML 엔지니어',
    ...
    strengthsNeeded: ['수학적 사고', '패턴 인식 능력', '데이터 해석 능력', '실험적 방법론 적용'],
    challengesExpected: ['대규모 학습 데이터 관리', '모델 성능과 해석 가능성 균형', '편향 및 윤리적 문제 대응']
  }
};
